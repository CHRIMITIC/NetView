...
CREATE TABLE `ports` (
  ...
  `ConnectedPort` int(11) NOT NULL,
  PRIMARY KEY (`DeviceId`,`ConnectedPort`,`PortName`),
  UNIQUE KEY `PortId` (`PortId`),
  KEY `ConPort` (`ConnectedPort`),
  CONSTRAINT `ConPort` FOREIGN KEY (`ConnectedPort`) REFERENCES `ports` (`PortId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `ports` VALUES (1,'Fa0','Up',0,2),(2,'Fa1','Down',1,1);
